...
<?php
    ...
    $order_info_query = "SELECT invoice_id, i.order_num, order_date
                        FROM invoices i, customer_orders c
                        WHERE c.order_num = i.order_num
                        AND cust_num = " . $_SESSION['cust_num'] . "
    ...
    <div style="border-bottom: black solid thin; height: 25px;">
        <div style=" width: 33%; height: 100%; float: left; border-right: black thin solid; ">
            <h3 style="text-align: center; margin-top: 3px;">
                <a href="customer_page.php?menu=invoice&order_num=<?php echo $order_num ; ?>"> <?php echo $order_date ; ?> </a>
            </h3>
        </div>
        <div style=" width: 33%; height: 100%; float: left; border-right: black thin solid; ">
            <h3 style="text-align: center; margin-top: 3px;">
                <a href="customer_page.php?menu=invoice&order_num=<?php echo $order_num ; ?>"> <?php echo $order_num ; ?> </a>
            </h3>
        </div>
        <div style=" width: 33%; height: 100%; float: left; ">
            <h3 style="text-align: center; margin-top: 3px;">
                <a href="customer_page.php?menu=invoice&order_num=<?php echo $order_num ; ?>"> <?php echo $invoice_id ; ?> </a>
            </h3>
        </div>
    </div>
<?php } ?>
