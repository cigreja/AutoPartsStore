...
<?php
//first check if part or keyword search was passed
if(isset($_POST['part_number']) || isset($_POST['key_word']) ){ // handle part number search filter
   // do not display filters
   // do nothing
}else{ // handle year and model form search filter
   ?>
