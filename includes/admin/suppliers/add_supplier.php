...
<div style="width: 75%; float: left; border: black solid thin; margin: 2%; padding-bottom: 0px;">
        <div style="width: 100%; margin: 0px; background-color: #f0f0f0; ">
            <h4 style="margin: 0px;">Add Supplier</h4></label>
        </div>
        
    
        <!-- Add Supplier Form-->
        <div style="width: 100%; padding: 10px; margin-left: 30%;">
        <form id="register_form" action="suppliers/update_info.php?update=add_supplier" method="post">

            <label>Name: </label>
            <input type="text" name="firstName"  style="margin: 5px 0px 5px 72px;" required>
            <br>
            ...
            <div style="text-align: center; margin-top: 10px;"> 
                <input type="submit" name="btnSubmit" style="width: 130px; height: 30px; margin-right: 40%;" value="Add Supplier" />
            </div>
        </form>
    </div>
</div>     