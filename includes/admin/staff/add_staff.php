...
<div style="width: 75%; float: left; border: black solid thin; margin: 2%; padding-bottom: 0px;">
        ...
        <!-- Add Supplier Form-->
        <div style="width: 100%; padding: 10px; margin-left: 25%;">
        <form id="register_form" action="staff/staff_update_info.php?update=add_staff" method="post">
            ...
            <br>
            <label>Email: </label>
            <input type="email" name="email" id="email"  style="margin: 5px 0px 5px 73px; width: 174px; height: 22px;" required>
            <br>
            <label>Password: </label>
            <input type="password" name="password" id="password"  style="margin: 5px 0px 5px 49px; width: 174px; height: 22px;" required>
            <br>
            <div style="text-align: left; margin-top: 10px; margin-left: 15%;"> 
                <input type="submit" name="btnSubmit" style="width: 130px; height: 30px;" value="Add Staff" />
            </div>
        </form>
    </div>
</div>     