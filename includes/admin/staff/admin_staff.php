<div style="border: #1E6091 thin solid; width: 50%; float: left; margin: 10px;">
    ...
    <div style="width: 100%; padding: 10px;">
        <form id="register_form" action="update_info.php?update=general" method="post">
			...
			<select type="number" name="IDNumber" value=""margin: 5px 0px 5px 70px;" required>
			<br>
            <label>First Name: </label>
            <select type="text" name="firstName" value="" style="margin: 5px 0px 5px 34px;" required>
            <br>
			...
			<!-- The buttons should so as follows:
					Add: Make the data entered into the fields the next employee.
					Update: make the current data in the field become the currently chosen admin_num
					Remove: Delete the currently selected admin_num from the database - Try making sure there will still be one admin left.
					-->
			<div style="text-align: center; margin-top: 10px;"> 
                <input type="submit" name="btnAdd" style="width: 130px; height: 30px;" value="Add" />
            </div>
            <div style="text-align: center; margin-top: 10px;"> 
			...
			<div style="text-align: center; margin-top: 10px;"> 
                <input type="submit" name="btnRemove" style="width: 130px; height: 30px;" value="Remove" />
            </div>
        </form>
    </div>
</div>