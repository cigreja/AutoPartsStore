...
function delete_staff(staff_id){
   window.location.href = 'staff/staff_update_info.php?staff_id='+staff_id+'&update=delete_staff&menu=staff&sub_menu=delete_staff';
}
...
?>
       ...
       <div style="width: 75%; float: left; border: black solid thin; margin: 2%; padding-bottom: 0px;">
        <div style="width: 100%; margin: 0px; background-color: #f0f0f0; ">
            <h4 style="margin: 0px;">Add Staff</h4></label>
        </div>
        
    
        <!-- Add Supplier Form-->
        <div style="width: 100%; padding: 10px; margin-left: 27%;">
            <form id="register_form" action="staff/staff_update_info.php?manu=staff&sub_menu=staff&update=staff&staff_id=<?php echo $staff_id; ?>" method="post">

            <label>First Name: </label>
            <input type="text" name="firstName" value="<?php echo $first_name; ?>" style="margin: 5px 0px 5px 34px;" required>
            <br>
            <label>Last Name: </label>
            <input type="text" name="lastName" value="<?php echo $last_name; ?>" style="margin: 5px 0px 5px 36px;" required>
            <br>
            <label>Address: </label>
            ...
            <br>
            <label>Email: </label>
            <input type="email" name="email" id="email" value="<?php echo $email; ?>" style="margin: 5px 0px 5px 73px; width: 174px; height: 22px;" required>
            <br>
            <label>Password: </label>
            <input type="password" name="password" id="password" value="<?php echo $password; ?>" style="margin: 5px 0px 5px 49px; width: 174px; height: 22px;" required>
            <br>
            <div style="text-align: left; margin-top: 10px;"> 
                <input type="submit" name="btnSubmit" style="width: 130px; height: 30px; margin: 10px;" onclick="this.form.submit()" value="Update Staff" />
                <input type="button" name="btnSubmit" style="width: 130px; height: 30px; margin: 10px;" onclick="delete_staff(<?php echo $staff_id ; ?>)" value="Delete Staff" />
            </div>
        </form>
    </div>
