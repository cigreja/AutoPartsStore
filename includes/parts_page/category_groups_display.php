...
<!-- Category Groups -->
    <div style="width: 86%; float: left; border: black solid thin; margin: 2%; padding-bottom: 0px;">
       ...
       // handle keyword search form post
if(isset($_POST['key_word'])){ // handle keyword search
           // if year and model is set
           if(isset($_SESSION['year']) && $_SESSION['model'] != "null"){
            ...
            $query = "SELECT distinct table_name, categories_name 
                      ...
                      AND table_name LIKE '%" . $_POST['key_word'] . "%' " . "
                      AND categories_name LIKE '%" . $_POST['key_word'] . "%';";
        ...
        <div style="width: 29%; float: left; margin: 2%;" class="Category_Groups" >
        ...
        <?php   while ($sub_group_row = mysqli_fetch_assoc($sub_groups)) {
         ...
         <?php } ?> </ul> 
               ...
               // Needs a year and model first
                echo '<p> <br> Please choose a year and model first. </p>';
                //$parts = null;
           }
           
 // handle year and model form post
}  else if(isset($_SESSION['year']) && $_SESSION['model'] != "null"){ 
